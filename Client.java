            ...
            public  void run(){
                ...
                while(socket.isConnected()){
                    try{
                        ...
                        if(msgFromClient.startsWith("MSG:")){
                            System.out.println(msgFromClient.substring(5).trim());
                        } else if (msgFromClient.startsWith("INFO:")) {
                            System.out.println("[INFO] " + msgFromClient.substring(5).trim());
                        } else if (msgFromClient.startsWith("USERS:")) {
                            String usersList = msgFromClient.substring(6).trim();
                            System.out.println("[Active Users] " + usersList);
                        }else{
